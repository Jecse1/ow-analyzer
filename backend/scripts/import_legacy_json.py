"""
Legacy migration tool. Use only for restoring from scrim_data.json backup.
NOT used in normal Phase 5+ operation — DB is the single source of truth.

Run from backend/ directory:
    python -m scripts.import_legacy_json
